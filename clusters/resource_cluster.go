...
func (ClusterSpec) CustomizeSchema(s map[string]*schema.Schema, prefix string) map[string]*schema.Schema {
	...
	common.CustomizeSchemaPath(s, "node_type_id").SetComputed().SetConflictsWith(prefix, []string{"driver_instance_pool_id", "instance_pool_id"})
	common.CustomizeSchemaPath(s, "driver_node_type_id").SetComputed().SetConflictsWith(prefix, []string{"driver_instance_pool_id", "instance_pool_id"})
	common.CustomizeSchemaPath(s, "driver_instance_pool_id").SetComputed().SetConflictsWith(prefix, []string{"driver_node_type_id", "node_type_id"})
	...
	common.CustomizeSchemaPath(s, "aws_attributes").SetSuppressDiff().SetConflictsWith(prefix, []string{"azure_attributes", "gcp_attributes"})
	common.CustomizeSchemaPath(s, "aws_attributes", "zone_id").SetCustomSuppressDiff(ZoneDiffSuppress)
	common.CustomizeSchemaPath(s, "azure_attributes").SetSuppressDiff().SetConflictsWith(prefix, []string{"aws_attributes", "gcp_attributes"})
	common.CustomizeSchemaPath(s, "gcp_attributes").SetSuppressDiff().SetConflictsWith(prefix, []string{"aws_attributes", "azure_attributes"})
	...
	common.CustomizeSchemaPath(s, "instance_pool_id").SetConflictsWith(prefix, []string{"driver_node_type_id", "node_type_id"})
