...
func (JobSettingsResource) CustomizeSchema(s map[string]*schema.Schema) map[string]*schema.Schema {
	...
	common.CustomizeSchemaPath(s, "schedule").SetConflictsWith([]string{"continuous", "trigger"})
	common.CustomizeSchemaPath(s, "continuous").SetConflictsWith([]string{"schedule", "trigger"})
	common.CustomizeSchemaPath(s, "trigger").SetConflictsWith([]string{"continuous", "schedule"})
	...
	common.CustomizeSchemaPath(s, "run_as", "user_name").SetExactlyOneOf(run_as_eoo)
	common.CustomizeSchemaPath(s, "run_as", "service_principal_name").SetExactlyOneOf(run_as_eoo)
